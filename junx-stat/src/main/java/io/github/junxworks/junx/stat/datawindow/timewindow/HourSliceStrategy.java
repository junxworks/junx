...
/**
 * 基于小时的时间窗口切分策略，每个切分块就是1小时
 *
 * @author: Michael
 * @date:   2017-5-17 17:55:02
 * @since:  v1.0
 */
public class HourSliceStrategy extends UnitBasedSliceStrategy {
	...
	public void setPacemakerTime(SlicedBlock block) {
		block.setPacemakerTime(block.getExpireTimePoint() + TimeUnit.hour.getMillis() - 1); //少一毫秒
	}

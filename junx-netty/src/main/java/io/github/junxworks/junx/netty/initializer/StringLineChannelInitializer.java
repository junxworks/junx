 ...
 ***************************************************************************************
 * 
 * @Title:  StringLineChannelInitializer.java   
 ...
 * @since:  v1.0
 */
public class StringLineChannelInitializer extends ChannelInitializer<Channel> {
	...
	public StringLineChannelInitializer(ChannelInboundHandler eventHandler) {
	...
	protected void initChannel(Channel ch) throws Exception {
		...
		p.addLast("frameDecoder", new LineBasedFrameDecoder(Integer.MAX_VALUE));//基于换行符的frame decoder
		p.addLast("decoder", new StringDecoder());
		p.addLast("frameEncoder", new LineEncoder()); // 添加MessagePack编码器

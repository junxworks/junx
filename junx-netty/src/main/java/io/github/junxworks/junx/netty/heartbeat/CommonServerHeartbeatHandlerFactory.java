 ...
 ***************************************************************************************
 * 
 * @Title:  CommonServerHeartbeatHandlerFactory.java   
 ...
 * @since:  v1.0
 */
public class CommonServerHeartbeatHandlerFactory implements HeartbeatHandlerFactory {

	/** heartbeat response bytes. */
	public static byte[] HEARTBEAT_RESPONSE_BYTES = new byte[] { MessageConstants.MESSAGE_TYPE_HEARTBEAT };

	@Override
	public ChannelInboundHandler createHeartbeatHandler() throws Exception {
		return new ServerHeartbeatCheckHandler(new HeartbeatMessageFilter() {
			@Override

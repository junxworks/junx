 ...
 ***************************************************************************************
 * 
 * @Title:  ClientHeartbeatCheckHandler.java   
 ...
 * @since:  v1.0
 */
public class ClientHeartbeatCheckHandler extends ChannelInboundHandlerAdapter {

	private static final Logger logger = LoggerFactory.getLogger(ClientHeartbeatCheckHandler.class);
	...
	public ClientHeartbeatCheckHandler(HeartbeatMessageFilter heartbeatMessageFilter, Object heartbeatMessage) {

 ...
 ***************************************************************************************
 * 
 * @Title:  DirectoryNotFoundException.java   
 ...
 * @since:  v1.0
 */
public class DirectoryNotFoundException extends BaseRuntimeException {
	 ...
	 */
	public DirectoryNotFoundException(Throwable ex) {
		super(ex);
	}
	 ...
	 */
	public DirectoryNotFoundException(String msg, Throwable ex) {
		super(msg, ex);
	}
	 ...
	 */
	public DirectoryNotFoundException(String msg, Object... args) {
		super(msg, args);
	}
	 ...
	 */
	public DirectoryNotFoundException(String msg, Exception e, Object... args) {
		super(msg, e, args);
	}
}
